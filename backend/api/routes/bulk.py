...
async def validate_bulk_generation(
    ...
    Приймає список ID співробітників та дати.
    Повертає два списки:
    - **valid**: співробітники, для яких можна створити документ.
    - **invalid**: співробітники, для яких не можна створити документ (з причиною помилки).
    
    Враховує перетини дат відпусток та існуючих документів.
    """
...
async def generate_bulk_documents(
    ...
    Створює документи для всіх валідних співробітників зі списку.
    Генерує .docx файли та записи в БД.
    Повертає IDs створених документів.
    """
    from backend.models.staff import Staff
